<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Application.aspx.cs" Inherits="Yemekkutusu.Application" %>
...
<body>
  ...
  <div class="row justify-content-md-center align-items-center mt-2">
    <div class="card col-md-auto mt-4 text-center ">
                    ...
                    <button type="submit" class="btn btn-danger mb-3">Şifremi Unuttum !</button>

                    <small id="emailHelp" class="form-text text-muted mb-3">Henüz Üye Değil misin ?</small>

                    <button type="submit" class="btn btn-success mb-3" >Üye Ol</button>
